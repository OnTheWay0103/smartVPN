...
const whitelist = require('../config/whitelist.example')
const logger = require('../lib/utils/logger')
const { setProxy, closeProxy } = require('../tools/setProxy')
const path = require('path')

// 解析命令行参数
const args = process.argv.slice(2)
const enableWhitelist = args.includes('--white')
